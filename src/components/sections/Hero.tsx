        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left z-10">
            ...
            <h1 className="font-title text-5xl md:text-7xl font-bold mb-6 leading-[1.1] text-balance">
              {t('person')} <span className="text-primary drop-shadow-sm">Franck</span>
          ...
          <div className="relative flex-1 w-full max-w-125">
            ...
            <div className="relative z-10 group rounded-[2.5rem] overflow-hidden border border-primary/10 bg-linear-to-br from-abyss-800/20 to-abyss-900/40 pt-10 p-1 backdrop-blur-sm">
              <Image
            ...
            <div className="absolute -top-6 -left-8 md:-left-16 z-20 bg-bg-card/90 backdrop-blur-xl p-5 rounded-2xl shadow-2xl border border-primary/20 animate-bounce-slow">
              <p className="text-2xl font-bold text-primary font-title text-center">15+</p>
