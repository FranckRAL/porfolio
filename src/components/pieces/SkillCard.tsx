  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 mb-8">
        <div className="p-3 rounded-xl bg-primary/10 group-hover:bg-primary group-hover:text-white transition-all duration-500">
          <category.icon size={24} />
        </div>
        <h3 className="font-title text-xl font-bold">{category.title}</h3>
      </div>
        ...
        {category.skills.map((skill, idx) => (
          <div key={idx} className="space-y-2">
            <div className="flex justify-between items-end">
              <span className="text-sm font-medium text-text-main/80">{skill.name}</span>
