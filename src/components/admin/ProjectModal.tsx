...
export default function ProjectModal({
    ...
    if (isOpen) {
      if (projectToEdit) {
        setFormData({
          ...
          description: {
            fr: projectToEdit.description.fr,
            en: projectToEdit.description.en,
          },
          features: {
  ...
  type I18nField = "title" | "description" | "features" | "challenges";

  const handleI18nChange = (field: I18nField, value: string) => {
    setFormData((prev) => ({
      ...prev,
        ...
        <form onSubmit={handleSubmit} className="p-8 overflow-y-auto space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleI18nChange("description", e.target.value)
                }
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-abyss-900 border border-primary/10 rounded-xl p-3 pl-12 text-sm outline-none"
                    placeholder="Year"
                  />
                </div>
                <div className="relative">
            ...
            <div className="lg:col-span-4 space-y-6">
              <CldUploadWidget
                ...
                onSuccess={(res: any) =>
                  setFormData((p) => ({ ...p, imageUrl: res.info.secure_url }))
                }
              >
                {({ open }) => (
                  <button
                    type="button"
                    onClick={() => open()}
                    className="w-full aspect-video lg:aspect-square border-2 border-dashed border-primary/20 rounded-2xl flex flex-col items-center justify-center hover:border-primary transition-all relative overflow-hidden group"
                  >
                    {formData.imageUrl ? (
                      <>
                        <Image
                      ...
                      <div className="text-center p-4">
                        <FaUpload className="mx-auto text-text-muted mb-2" />
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 bg-abyss-900 border border-primary/10 rounded-xl p-3">
                  <FaGlobe size={16} className="text-text-muted" />
                  <input
                    type="url"
          ...
          <div className="space-y-4">
            ...
            <input
              ...
              onChange={(e) =>
                setFormData((p) => ({ ...p, stackInput: e.target.value }))
              }
